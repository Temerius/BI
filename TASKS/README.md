...
State -> Region
1. Create a chart that shows Average of Sales by State and Region, add any filters you want.
...
1. Create a dashboard that represents Count of Orders by Category and Subcategory,
use a calculated table to do it.
1. Add 1-2 charts by your choice
